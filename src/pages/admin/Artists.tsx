  ...
  return (
    <div>
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between mb-6">
        ...
        <button className="btn-primary flex items-center justify-center gap-2 shrink-0 w-full sm:w-auto" onClick={() => { setEditing(null); setShowModal(true); }}><Plus size={15} /> Neuer Künstler</button>
      </div>
